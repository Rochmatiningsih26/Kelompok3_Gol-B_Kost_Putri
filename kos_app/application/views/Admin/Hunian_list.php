...
<div id="page-wrapper" >
    <div id="page-inner">
      <div class="row">
        <div class="col-lg-12">
           <h2>DATA KAMAR KOST</h2>
           <hr> 
		</div><?=$this->session->flashdata('pesan')?>	
		<div class="col-md-12 text-right">
		<a href="<?php echo site_url('hunian/tambah'); ?>" class="btn btn-success" 
		...
		<table id="example" class="table table-striped table-bordered">
			...
			<tbody>
				...
				<tr class="warning">
					...
					<td><img style="width:300px; height: 200px;" width="50%" height="50%" src="<?php echo site_url()?>assets/admin/uploads/<?php echo $value->gambar; ?>"></td>
					<td>
